...
<scroller class="index">
    ...
    <slider class="size" auto-play="true" interval="2800">
    ...
    <floor :floors="floors" />
  <header>
      <text class="banner">Java 教程</text>
    </header>
</div>
</scroller>
</template>
...
<script>
 ...
 posters: [
      ...
      floors: [
      {
        ...
        tabs: [
        { title: '首页',url:'one', icon: 'https://gw.alicdn.com/tfs/TB19YESOVXXXXaNaXXXXXXXXXXX-45-45.png' },
        { title: '耍帅', url:'one',icon: 'https://gw.alicdn.com/tfs/TB1I2E9OVXXXXbFXVXXXXXXXXXX-45-45.png' },
        { title: '旅行',url:'one', icon: 'https://gw.alicdn.com/tfs/TB1gUhyPXXXXXX5XXXXXXXXXXXX-45-45.png' },
        { title: '潮玩', url:'one',icon: 'https://img.alicdn.com/tfs/TB1D4RzQFXXXXcoXpXXXXXXXXXX-45-45.png' },
        { title: '穿搭', url:'one',icon: 'https://gw.alicdn.com/tfs/TB1N1.6OVXXXXXqaXXXXXXXXXXX-45-45.png' }
      ]
      }
    }
  }
